...
const COMMANDS = [
  ...
  { bin: "ccenv", sub: "pin", args: "<name> [dir]", desc: "Attach an account to a folder; terminals there auto-use it (default: cwd)." },
  { bin: "ccenv", sub: "unpin", args: "[dir]", desc: "Remove a folder pin (defaults to the current directory)." },
  { bin: "ccenv", sub: "pins", args: "", desc: "List every directory pin; flags stale ones." },
